...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('tests_run', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('failure_count', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('bravo_server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['settings.Server'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('root_path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('preprod_server', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['settings.PreprodServer'], null=True, on_delete=models.SET_NULL, blank=True)),
            ('preprod_path', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('status', self.gf('django.db.models.fields.TextField')(default='Testing')),
        ))
        ...
        # Adding model 'VoiceSlot'
        db.create_table(u'projects_voiceslot', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('vuid', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.VUID'], null=True, on_delete=models.SET_NULL)),
            ...
            ('verbiage', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('checked_out', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('checked_out_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('bravo_checksum', self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True)),
            ('bravo_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('vuid_time', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('check_in_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['VoiceSlot'])

        # Adding model 'VUID'
        db.create_table(u'projects_vuid', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('upload_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, on_delete=models.SET_NULL)),
        ))
        db.send_create_signal(u'projects', ['VUID'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'VoiceSlot'
        db.delete_table(u'projects_voiceslot')

        # Deleting model 'VUID'
        db.delete_table(u'projects_vuid')
