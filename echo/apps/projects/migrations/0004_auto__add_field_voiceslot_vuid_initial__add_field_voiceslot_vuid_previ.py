...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoiceSlot.vuid_initial'
        db.add_column(u'projects_voiceslot', 'vuid_initial',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoiceSlot.vuid_previous'
        db.add_column(u'projects_voiceslot', 'vuid_previous',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoiceSlot.verbiage_previous'
        db.add_column(u'projects_voiceslot', 'verbiage_previous',
                      self.gf('django.db.models.fields.TextField')(default='', null=True, blank=True),
                      keep_default=False)

        # Adding field 'VoiceSlot.vuid_time_previous'
        db.add_column(u'projects_voiceslot', 'vuid_time_previous',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoiceSlot.vuid_initial'
        db.delete_column(u'projects_voiceslot', 'vuid_initial')

        # Deleting field 'VoiceSlot.vuid_previous'
        db.delete_column(u'projects_voiceslot', 'vuid_previous')

        # Deleting field 'VoiceSlot.verbiage_previous'
        db.delete_column(u'projects_voiceslot', 'verbiage_previous')

        # Deleting field 'VoiceSlot.vuid_time_previous'
        db.delete_column(u'projects_voiceslot', 'vuid_time_previous')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'jira_key': ('django.db.models.fields.CharField', [], {'max_length': '12', 'blank': 'True'}),
