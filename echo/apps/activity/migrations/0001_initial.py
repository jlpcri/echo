...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Scope'
        db.create_table(u'activity_scope', (
            ...
            ('voiceslot', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.VoiceSlot'], null=True, blank=True)),
        ))
        db.send_create_signal(u'activity', ['Scope'])
        ...
        db.create_table(u'activity_action', (
            ...
            ('scope', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['activity.Scope'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'activity_scope')
