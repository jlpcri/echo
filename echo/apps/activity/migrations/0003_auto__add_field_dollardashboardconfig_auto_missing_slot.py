...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DollarDashboardConfig.auto_missing_slot'
        db.add_column(u'activity_dollardashboardconfig', 'auto_missing_slot',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DollarDashboardConfig.auto_missing_slot'
        db.delete_column(u'activity_dollardashboardconfig', 'auto_missing_slot')
    ...
    models = {
        ...
        u'activity.dollardashboardconfig': {
            ...
            'auto_missing_slot': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
